Банковские операции Это виджет, который показывает несколько последних успешных банковских операций клиента.
...
Тестирование добавлены тесты для модулей:

mask.py
processing.py
widget.py

Генераторы добавлена функция генераторов и тесты к ним:
